...
class ScriptTest < Test::Unit::TestCase
  ...
  def test_approve_from_user
    ...
    return "ERROR! We should not allow merge to main branch without approve from #{user_name}" if classic_require_code_owner_review || rulesets_require_code_owner_review
    end
